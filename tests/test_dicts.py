...
def test_merge(original, updates, expected_output):
    assert merge_dict(original, updates) == expected_output
...
def test_merge_with_postprocessor():
    ...
    assert (
        merge_dict(original, updates, post_processor=postprocessor) == expected_output
    )
...
def test_merge_with_key_order():
    ...
    result = merge_dict(original, updates, key_order=["a", "b", "c"])
...
def test_merge_with_key_order_partial():
    ...
    result = merge_dict(original, updates, key_order=["a", "c"])
    assert result == expected_output
...
def test_merge_with_key_order_none():
    ...
    result = merge_dict(original, updates, key_order=None)
    assert result == expected_output
